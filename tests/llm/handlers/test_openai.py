...
class TestOpenAILLMHandler:
    ...
    def test_parse_response_with_tool_calls(self):
        ...
        mock_tool_call = SimpleNamespace(id="call_123", function=mock_function, index=0)
    ...
    def test_create_tool_message(self):
        ...
        tool_call = ToolCall(id="call_123", name="get_weather", arguments={"location": "NYC"}, index=0)
