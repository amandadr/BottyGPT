...
class TestGoogleLLMHandler:
    ...
    def test_parse_response_with_function_call(self, mock_uuid):
        ...
        mock_function_call = SimpleNamespace(name="get_weather", args={"location": "San Francisco"})
    ...
    def test_parse_response_with_mixed_parts(self, mock_uuid):
        ...
        mock_function_call = SimpleNamespace(name="get_weather", args={"location": "NYC"})
    ...
    def test_parse_response_direct_function_call(self, mock_uuid):
        ...
        mock_function_call = SimpleNamespace(name="calculate", args={"expression": "2+2"})
        mock_response = SimpleNamespace(function_call=mock_function_call, text="The calculation result is:")
    ...
    def test_parse_response_direct_function_call_no_text(self):
        ...
        mock_function_call = SimpleNamespace(name="get_data", args={"id": 123})
    ...
    def test_create_tool_message(self):
        ...
        tool_call = ToolCall(id="call_123", name="get_weather", arguments={"location": "Tokyo"}, index=0)
